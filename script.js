...
var flyer0 = imgs[0].setAttribute("src", "sao-joao-flyer.png");
var flyer1 = imgs[1].setAttribute("src", "ignite-v80-flyer.png");
var flyer2 = imgs[2].setAttribute("src", "elfbar-bc10000-flyer.png");
var flyer3 = imgs[3].setAttribute("src", "elfbar-te-5000-flyer.png");
var flyer4 = imgs[4].setAttribute("src", "sao-joao-flyer.png");
//LINKS
imgs[0].addEventListener("click", function(){
    location.href = "https://api.whatsapp.com/send?phone=5574981559545&text=Ol%C3%A1,%20vim%20pelo%20site!%20%F0%9F%91%80%0AGostaria%20de%20saber%20quais%20s%C3%A3o%20as%20novidades?";
});
imgs[1].addEventListener("click", function(){
    location.href = "https://api.whatsapp.com/send?phone=5574981559545&text=Ol%C3%A1,%20vim%20pelo%20site!%20%F0%9F%91%80%0AGostaria%20de%20saber%20se%20o%20%20IGNITE%20V80%20ainda%20est%C3%A1%20dispon%C3%ADvel?";
});
imgs[2].addEventListener("click", function(){
    location.href = "https://api.whatsapp.com/send?phone=5574981559545&text=Ol%C3%A1,%20vim%20pelo%20site!%20%F0%9F%91%80%0AGostaria%20de%20saber%20se%20o%20%20ELFBAR%20BC10000%20ainda%20est%C3%A1%20dispon%C3%ADvel?";
});
...
function emojiAlternator(){
    setTimeout(function(){
        document.getElementsByTagName("head")[0].children[20].innerHTML = "𝗡𝗢𝗥𝗗𝗘𝗦𝗧𝗘 𝗣𝗢𝗗𝗭 &#127797; • Catálogo Online e Interativo";
    }, 1500);
    setTimeout(function(){
        document.getElementsByTagName("head")[0].children[20].innerHTML = "𝗡𝗢𝗥𝗗𝗘𝗦𝗧𝗘 𝗣𝗢𝗗𝗭 &#128142; • Catálogo Online e Interativo";
        emojiAlternator();
